...
- Change `process/allowlist.json` or `process/scenes/` only when the user explicitly owns that change. Those paths are in `.github/CODEOWNERS`; do not bypass human review.
